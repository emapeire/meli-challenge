...
export default function Home() {
  return (
    <>
      <section className='border border-neutral-400 bg-neutral-100 rounded py-12 px-4 gap-6 flex flex-col items-center justify-center font-bold'>
      ...
      <section className='border border-neutral-400 bg-neutral-100 rounded mt-8 flex flex-col items-center justify-center gap-6 py-24 px-4'>
